...
class CoverArtApi(private val coverArtService: CoverArtService) {
    ...
    @KtorRoute
    fun Route.getCoverArtList() = accessControl(AC.Scope.Admin.CoverManagement) {
        get {
    ...
    @KtorRoute("/{id}")
    fun Route.deleteCoverArt() = accessControl(AC.Scope.Admin.CoverManagement) {
        delete {
    ...
    @KtorRoute
    fun Route.uploadCoverArt() = accessControl(AC.Scope.Admin.CoverManagement) {
        post {
